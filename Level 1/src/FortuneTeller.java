...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	FortuneTeller() throws Exception {
		...
		// package
		fortuneTellerImage = ImageIO.read(getClass().getResource("156.jpg"));
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			String question = JOptionPane.showInputDialog("Ask me any question.");
			// 9. Find a spooky sound and put it in your default package
			// (freesound.org)
			AudioClip noise = JApplet.newAudioClip(getClass().getResource("scarynoise.aiff"));
			// AudioClip sound =
